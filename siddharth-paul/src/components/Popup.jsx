...
const Popup = ({ isOpen, onClose, userIdentifier }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.fullName.trim() || !formData.phoneNumber.trim() || !formData.email.trim() || !formData.address.trim()) {
    ...
    try {
      ...
      const response = await fetch('https://siddharth-paul.onrender.com/api/client-info', {
        method: 'POST',
        headers: {
    ...
    <div className="sp-popup-overlay">
      <div className="sp-popup-container">
        ...
        <div className="sp-popup-header">
          <h2 className="sp-popup-title">
            Access Free Income Starter Pack
          </h2>
