...
const OfferVaultUpsellCheckout = () => {
  ...
  if (loading) {
    return <div className="offer-vault-checkout">Loading...</div>;
  }

  if (!courseData) {
    return (
      <div className="offer-vault-checkout">Failed to load course data</div>
    );
  }
  ...
  return (
    <div className="offer-vault-checkout" id="offer-vault-checkout">
      <div className="offer-vault-container">
        <header className="offer-vault-header">
        </header>
