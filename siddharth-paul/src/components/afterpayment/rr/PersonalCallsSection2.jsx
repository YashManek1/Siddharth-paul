...
const PersonalCallsSection2 = () => {
    ...
    const fetchCourseData = async () => {
      try {
        const response = await fetch(
          "https://siddharth-paul.onrender.com/courses/ROAS-Rocket"
        );
        if (response.ok) {
  ...
  const price = courseData?.afterPaymentPrice || "2999";
  const finalPrice = courseData?.afterPaymentPrice || "1499";
        ...
        <div className="personal-calls-grid-container">
          <div className="personal-calls-card personal-calls-card-calls">
            ...
            <p className="personal-calls-card-description">
              Join private 1-1 calls with me where I help you fix your ads, step
              by step. I'll look at your hooks, scripts, editing, and budgets.
              Ask me anything.
            </p>
          ...
          <div className="personal-calls-card personal-calls-card-growth">
            ...
            <p className="personal-calls-card-description">
              You'll get my eyes on your ads — I'll check each line, headline,
              video flow, and call to action. I'll show you what's weak, what to
              make stronger, and what to test next.
            </p>
          ...
          <div className="personal-calls-card personal-calls-card-close">
            ...
            <p className="personal-calls-card-description">
              I won't just give you a template — I'll write your ads for you.
              You'll tell me about your offer, and I'll craft hooks, angles, and
              full scripts that fit your style and audience. I'll help you fix
              every line so you know your ad is ready to win — all done with
              you.
            </p>
            <div className="personal-calls-card-image">
