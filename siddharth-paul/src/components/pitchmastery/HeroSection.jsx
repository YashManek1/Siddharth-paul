    ...
    <main className="gm-hero-section">
      <div className="gm-hero-content">
        <h1 className="gm-hero-main-title">
          ...
          <span className="gm-text-black">MASTER</span>{" "}
          <span className="gm-text-purple">SALES CALLS</span>{" "}
          <span className="gm-text-black">THAT</span>{" "}
        </h1>
        <h2 className="gm-sub-title">
          <span className="gm-text-purple">CLOSE DEALS</span>{" "}
          <span className="gm-text-black">EVERY WEEK</span>
        </h2>

        <div className="gm-features-list">
          <span>
            <img src={checkmarkIcon} alt="checkmark" /> CONSISTENT CLOSINGS
          </span>
          <span>
            <img src={checkmarkIcon} alt="checkmark" /> HANDLING LIKE A PRO
          </span>
          <span>
            <img src={checkmarkIcon} alt="checkmark" /> NO AWKWARD SALES TALKS
          </span>
        </div>
